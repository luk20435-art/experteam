    ...
    <div className="min-h-screen bg-gray-50 dark:bg-black">
      <div className="max-w-full mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold">Depart</h1>
            <p className="text-muted-foreground mt-1">
              All {suppliers.length} list {search && `• พบ ${filtered.length} รายการ`}
            </p>
          </div>
          <Link href="/depart/new">
        ...
        <Card>
          <CardHeader>
            <CardTitle>List All Depart</CardTitle>
          </CardHeader>
          <CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Depart Name</TableHead>
                      <TableHead className="hidden sm:table-cell">Supervisor</TableHead>
                      <TableHead className="hidden md:table-cell">Manafer</TableHead>
                      <TableHead>Storeman</TableHead>
                      <TableHead>Createed at</TableHead>
