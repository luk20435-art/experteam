...
export default function POEditPage() {
  ...
  const durationDays = deliveryDate && poData.orderDate
    ? differenceInDays(new Date(deliveryDate), new Date(poData.orderDate))
    : "-"
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 space-y-6">
          ...
          <div className="bg-white dark:bg-black rounded-lg shadow p-4 sm:p-6 border border-gray-200 dark:border-slate-900">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              ...
              <div className="space-y-2">
                ...
                <Input defaultValue={format(new Date(poData.orderDate), "dd/MM/yyyy")} readOnly className="h-10 bg-gray-100 dark:bg-black" />
              </div>
              <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              <div className="space-y-2">
                <Label className="text-sm">Trader</Label>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
              <div className="space-y-2">
                ...
                <Input defaultValue={poData.supplier || "-Select Suppliers-"} readOnly className="h-10 text-sm bg-gray-100 dark:bg-black" />
              </div>
              <div className="space-y-2">
          ...
          <div className="bg-white dark:bg-black rounded-lg shadow p-4 sm:p-6 border border-gray-200 dark:border-slate-800 ">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
              <h2 className="text-lg sm:text-xl font-bold">รายการสินค้า</h2>
              <Button onClick={addItem} className="bg-blue-600 hover:bg-blue-700 text-white w-full sm:w-auto hover:dark:bg-green-600">
                ...
                <span className="text-sm sm:text-base cursor-pointer">เพิ่มรายการ</span>
              </Button>
            </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-b border-gray-200 dark:border-slate-700">
                      <TableHead className="text-center text-xs sm:text-sm">ลำดับ</TableHead>
                      <TableHead className="text-xs sm:text-sm">รายการ</TableHead>
                      <TableHead className="text-center text-xs sm:text-sm">จำนวน</TableHead>
                      <TableHead className="text-center text-xs sm:text-sm">หน่วย</TableHead>
                  ...
                  <TableBody>
                    {items.map((item, index) => (
                      <TableRow key={index} className="border-b border-gray-100 dark:border-slate-800">
                        <TableCell className="text-center text-xs sm:text-sm py-3 sm:py-4">{index + 1}</TableCell>
            ...
            <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 dark:border-slate-700 space-y-3">
              ...
              <div className="flex justify-end gap-4 sm:gap-12 p-3 bg-blue-50 dark:bg-black rounded">
                <span className="text-sm sm:text-base">VAT (7.00%)</span>
                <span className="font-bold text-white w-24 sm:w-32 text-right text-sm sm:text-base">{vatAmount.toLocaleString()} บาท</span>
              </div>
              <div className="flex justify-end gap-4 sm:gap-12">
