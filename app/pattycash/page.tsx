...
export default function PattycashListPage() {
  ...
  const getStatusBadge = (status: string) => {
    const colorMap: { [key: string]: string } = {
      ...
      "รออนุมัติ": "bg-yellow-400 text-dark",
      "pending": "bg-yellow-400 text-dark",
      "อนุมัติแล้ว": "bg-green-600 text-white",
  ...
  return (
    <div className="min-h-screen space-y-4 md:space-y-6 max-w-full py-8 px-4 sm:px-6 lg:px-2  dark:bg-black">
      {/* Header */}
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold dark:text-white">Pattycash</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="font-sm text-slate-700">List All Pattycash ({totalItems} list)</CardTitle>
        </CardHeader>
        <CardContent>
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead>Pattycash No.</TableHead>
                      <TableHead className="hidden md:table-cell">Job Number</TableHead>
                      <TableHead className="hidden md:table-cell">Depart</TableHead>
